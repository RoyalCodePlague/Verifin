...
const sections = [
  ...
  { icon: Lock, title: "5. Data Security", content: "Your data is protected with secure authentication, HTTPS in production, and access-controlled infrastructure. We are continuing to strengthen encryption, backup, and compliance controls.", items: ["Authenticated access to protected account areas", "HTTPS for production connections", "Access controls for application infrastructure", "Ongoing improvements to encryption, backup, and compliance practices"] },
